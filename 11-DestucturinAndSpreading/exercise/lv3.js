...
const [name2, skills2, scores2] = student, [, , jsScore2, reactScore2] = scores

console.log(name, skills, jsScore, reactScore)
console.log(name2, skills2, jsScore2, reactScore2)


//forof duyệt giá trị của phần tử trong mảng
//forin duyệt index của phần tử trong mảng
...
function convertArrayToObject(arr){
    ...
    for (const u of arr){
        ...
        const [name, skills, scores] = u
        const userObj = {}

        userObj.name = name
        userObj.skills = skills
        userObj.scores = scores
        arrObj.push(userObj)
    }
    return arrObj
}
