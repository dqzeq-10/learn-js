...
// console.log(new Set(countries_data.flatMap(c => c.languages)))



// function CountLanguage(countriesObject){
//     return (new Set(countriesObject.flatMap(country => country.languages))).size
// }

// console.log(CountLanguage(countries_data))
